package com.gyn.agriculturalData.controller;

import com.gyn.agriculturalData.Constant.Constant;
import com.gyn.agriculturalData.pojo.*;
import com.gyn.agriculturalData.service.AgrituralDataService;
import com.gyn.agriculturalData.utils.IDUtils;
 ...
 */
@RestController
public class agriculturalDataController {

    private static Logger logger = LoggerFactory.getLogger(agriculturalDataController.class);

    @Autowired
    private AgrituralDataService agrituralDataService;
    @RequestMapping(value = "/real_data-get",method = RequestMethod.GET)
    public Result realDataGet(){
        Result result = new Result();
        List<RealData> list = null;
        try{
            list = agrituralDataService.RealdataGet();
...
//            }
    ...
    public Result differentData(@RequestBody Types type){
        logger.info("{}===========运行成功！============",type.getTypes());
        Result result = new Result();
        List<RealData> list = null;
        try{
            ...
            switch(type.getTypes()){
                case Types.airTemp:
                    list = agrituralDataService.airTempdataGet();
                    break;
                case Types.airHumi:
                    list = agrituralDataService.airHumidataGet();
                    break;
                case Types.soilTemp:
                    list = agrituralDataService.soilTempdataGet();
                    break;
                case Types.soilHumi:
                    list = agrituralDataService.soilHumidataGet();
                case Types.light:
                    list = agrituralDataService.lightdataGet();
                case Types.co2:
                    list = agrituralDataService.co2dataGet();
            }
...
//        Result result = new Result();
//        try{
//            materialService.jiaoshuiPut(watering);
//            result.setCode(Constant.SUCCESS_CODE);
//            result.setMessage(Constant.SUCCESS_MESSAGE);
//        } catch (Exception e){
//            e.printStackTrace();
...
//        Result result = new Result();
//        try{
//            materialService.questionTijiao(question);
//            result.setCode(Constant.SUCCESS_CODE);
//            result.setMessage(Constant.SUCCESS_MESSAGE);
//        }catch (Exception e){
//            e.printStackTrace();
...
//        try{
//            list = materialService.questionGet();
//            if(list == null || list.size() == 0){
//                result.setCode(Constant.RES_NOT_EXIST_CODE);
//                result.setMessage(Constant.RES_NOT_EXIST_MESSAGE);
//                return result;
