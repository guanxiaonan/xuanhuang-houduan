...
import com.gyn.material.mapper.MaterialMapper;
import com.gyn.material.pojo.*;
import com.gyn.material.service.MaterialService;
...
public class MaterialServiceimpl implements MaterialService {
    ...
    public void jiaoshuiPut(Watering watering){
        materialMapper.jiaoshuiPut(watering);
    }
    ...
    public List<Question> questionGet(){
        return materialMapper.questionGet();
    }

    @Override
    public void questionTijiao(Question question){
        materialMapper.questionTijiao(question);
    }
