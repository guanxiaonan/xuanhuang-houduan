package com.gyn.material.mapper;
...
public interface MaterialMapper {
    ...
    @Insert("INSERT INTO question (teagar_id,picture,user,stat_id,ques_describe) " +
            "VALUES (#{teagarId},#{picture},#{user},#{statId},#{quesDescribe})")
    public void questionTijiao(Question question);

    @Select("SELECT q.ques_id,q.teagar_id,tg.teagar_name,q.picture,q.user,q.stat_id,qs.status,q.ques_describe " +
            "FROM question as q,tea_garden as tg,ques_status as qs " +
            "WHERE q.teagar_id = tg.teagar_id AND q.stat_id = qs.stat_id")
