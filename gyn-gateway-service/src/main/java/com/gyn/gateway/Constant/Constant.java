package com.gyn.gateway.Constant;
...
public class Constant {
    ...
    public static String USER_SERVICE = "gyn-user-service";
    public static String MATERIAL_SERVICE = "gyn-material-service";
    public static String INVENTORY_SERVICE = "gyn-inventory-service";
    public static String PRODUCE_TASK_SERVICE = "gyn-produce-task-service";
}
