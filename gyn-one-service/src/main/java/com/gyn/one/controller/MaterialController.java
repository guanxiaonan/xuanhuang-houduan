package com.gyn.one.controller;

import com.gyn.one.pojo.*;
import com.gyn.one.service.MaterialFeignService;
import com.gyn.one.service.UserFeignService;
import com.gyn.one.utils.EntityToJsonUtil;
...
public class MaterialController {
    ...
    public Result jiaoshuiPut(@RequestBody Watering watering){
        return materialFeignService.jiaoshuiPut(watering);
    }
    ...
    public Result questionTijiao(@RequestBody Question question){
        return materialFeignService.questionTijiao(question);
    }
    ...
    public Result questionGet(){
        return materialFeignService.questionGet();
    }
