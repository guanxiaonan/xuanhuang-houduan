...
import com.gyn.one.pojo.TaskParam;
import com.gyn.one.service.impl.TaskFeignServiceHystrix;
 ...
 * 库存服务
 */
@FeignClient(value = "gyn-produce-task-service",fallback = TaskFeignServiceHystrix.class)
