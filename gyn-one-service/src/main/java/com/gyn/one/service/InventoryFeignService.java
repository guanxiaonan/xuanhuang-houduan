...
import com.gyn.one.pojo.InventoryRecord;
import com.gyn.one.pojo.Result;
import com.gyn.one.service.impl.InventoryFeignServiceHystrix;
 ...
 * 库存服务
 */
@FeignClient(value = "gyn-inventory-service",fallback = InventoryFeignServiceHystrix.class)
